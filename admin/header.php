    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo mt-1" src="../assets/img/logo/logoclp.png" width="160" height="20" alt="" /></a>
                <strong><a href="index.html"><img src="../assets/img/logo/clp.png" width="45" height="38" alt="" /></a></strong>
            </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="index.html"><img class="main-logo" src="../assets/img/logo/logoclp.png" width="160" height="20" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
